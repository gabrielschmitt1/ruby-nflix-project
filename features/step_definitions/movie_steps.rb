Dado("que {string} é um novo filme") do |movie_code|
  # Carregando um arquivo do tipo YAML
  file = YAML.load_file(File.join(Dir.pwd, "features/support/fixtures/movies.yaml"))
  # a variavel armazena o conteudo movie_code recebido por parametro
  @movie = file[movie_code]
  # Chamando a classe Database e removendo o movie_code usando seu titulo
